...
{
    public abstract class FMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FMSDbContext, Task<T>> func)
        {
            T result;
